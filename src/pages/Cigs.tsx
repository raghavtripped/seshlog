...
const CigsPage = () => {
  ...
  // FIX: Handlers for opening the form
    ...
    >
      <div className="space-y-8">
        ...
        <SessionList 
          ...
          error={error}
          category="cigs"
          onEditSession={handleOpenEditForm} // FIX: Pass the correct prop
          onDeleteSession={deleteSession}  // FIX: Pass the delete function from the hook
        />
      </div>
    </AppDashboard>
  );
