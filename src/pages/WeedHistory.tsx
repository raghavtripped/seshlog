...
const WeedHistory = () => {
  ...
  // Destructure the session data from the hook
  ...
  // Unified handler for when a session is added or updated to refetch data
  ...
  return (
    ...
    >
      <div className="space-y-8">
        {/* Back to Weed Dashboard and Action Row */}
